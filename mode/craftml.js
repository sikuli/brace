...
var HtmlHighlightRules = function() {
    ...
    this.addRules({
        ...
        module_attribute: [{
            ...
            include : "module_attribute_value",
            next: "attributes"
        }],
        module_attribute_value: [{
            ...
            push : [
                ...
                {include : "attr_reference"},
                {defaultToken : "string.module-link.attribute-value.xml"}
            ]
        }, {
            token : "string.attribute-value.xml",
            regex : '"',
